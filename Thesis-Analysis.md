...
```r
explanatory <- c('language', 'ville', 'gender', 'health', 'physically_active', 'q42', 'marital_status', 'ethnicity', 'q48', 'motor_vehicle_access', 'occupation_status', 'bmi_category', 'WalkScore', 'TransitScore', 'BikeScore', 'DiningandDrinkingScore', 'GroceryScore')
dependent <- "bmi"
ibiccs_clean %>%
...
## 18               language                         English 25.6 (4.7)
## 19                                              Fren/Span 26.0 (4.8)
## 35                  ville                          Boston 25.1 (4.6)
## 36                                                Chicago 25.9 (4.9)
## 37                                                Détroit 26.7 (5.1)
## 38                                               Montréal 25.9 (4.7)
## 39                                               New-York 25.0 (4.5)
## 40                                           Philadelphie 26.0 (5.0)
## 41                                                Toronto 25.6 (4.5)
## 42                                              Vancouver 24.9 (4.3)
## 10                 gender                          Female 25.0 (4.9)
## 11                                                   Male 26.4 (4.3)
## 13                 health                       Excellent 24.7 (4.1)
## 14                                                   Good 26.8 (5.0)
## 15                                                Missing 24.2 (5.7)
## 17                                                   Poor 28.4 (5.6)
## 29      physically_active                              No 26.7 (5.3)
## 30                                                  Other 26.3 (5.4)
## 31                                                    Yes 25.4 (4.5)
## 32                    q42                         [18,94] 25.6 (4.7)
## 20         marital_status                         Missing 24.1 (4.1)
## 21                        Relationship/Married/Common-Law 25.8 (4.6)
## 22                                                 Single 25.2 (4.8)
## 7               ethnicity                African American 27.7 (5.2)
## 8                          Arab/Indian/Jewish/Mixed/Other 25.1 (4.8)
## 9                                         Native American 25.6 (4.4)
## 33                    q48                          [1,99] 25.6 (4.7)
## 23   motor_vehicle_access                         Missing 24.9 (4.7)
## 24                                                     No 25.2 (4.8)
## 25                                                    Yes 25.8 (4.7)
## 26      occupation_status                        Employed 25.6 (4.6)
## 27                                                Student 24.2 (4.8)
## 28                                             Unemployed 26.4 (4.9)
## 2            bmi_category                   normal weight 22.2 (1.7)
## 3                                                   obese 33.6 (2.8)
## 4                                              overweight 27.1 (1.4)
## 5                                             underweight 18.1 (0.3)
## 43              WalkScore                         [0,100] 25.6 (4.7)
## 34           TransitScore                          [1,80] 25.6 (4.7)
## 1               BikeScore                         [1,138] 25.6 (4.7)
## 6  DiningandDrinkingScore                         [0,100] 25.6 (4.7)
## 12           GroceryScore                         [0,100] 25.6 (4.7)
## 16                   <NA>                            <NA>       <NA>
##          Coefficient (univariable)     Coefficient (multivariable)
## 18                               -                               -
## 19    0.43 (0.18 to 0.69, p=0.001)   0.79 (-0.20 to 1.77, p=0.119)
## 35                               -                               -
## 36    0.83 (0.57 to 1.10, p<0.001)   0.20 (-0.26 to 0.65, p=0.398)
## 37    1.69 (1.41 to 1.97, p<0.001)    0.79 (0.22 to 1.35, p=0.007)
## 38    0.82 (0.53 to 1.11, p<0.001)   0.61 (-0.27 to 1.50, p=0.173)
## 39  -0.01 (-0.28 to 0.26, p=0.937)   0.36 (-0.09 to 0.82, p=0.118)
## 40    0.96 (0.63 to 1.29, p<0.001)    0.57 (0.07 to 1.07, p=0.024)
## 41    0.54 (0.28 to 0.81, p<0.001)   0.51 (-0.04 to 1.06, p=0.072)
## 42  -0.18 (-0.47 to 0.11, p=0.213)   0.17 (-0.47 to 0.81, p=0.600)
## 10                               -                               -
## 11    1.39 (1.26 to 1.52, p<0.001)   0.03 (-0.19 to 0.25, p=0.789)
## 13                               -                               -
## 14    2.05 (1.91 to 2.19, p<0.001)    0.31 (0.08 to 0.54, p=0.009)
## 15                               -                               -
## 17    3.66 (3.45 to 3.87, p<0.001)   0.21 (-0.15 to 0.58, p=0.250)
## 29                               -                               -
## 30  -0.43 (-1.18 to 0.32, p=0.265)  -0.52 (-1.64 to 0.60, p=0.360)
## 31 -1.27 (-1.44 to -1.10, p<0.001)  -0.20 (-0.46 to 0.06, p=0.139)
## 32    0.06 (0.05 to 0.06, p<0.001)   0.00 (-0.01 to 0.01, p=0.654)
## 20                               -                               -
## 21    1.72 (0.93 to 2.50, p<0.001)   0.23 (-1.04 to 1.50, p=0.722)
## 22    1.15 (0.36 to 1.93, p=0.004)   0.10 (-1.17 to 1.36, p=0.882)
## 7                                -                               -
## 8  -2.67 (-3.22 to -2.12, p<0.001)  -0.10 (-0.37 to 0.17, p=0.467)
## 9  -2.13 (-3.45 to -0.82, p=0.001)  -0.47 (-1.06 to 0.12, p=0.115)
## 33 -0.01 (-0.02 to -0.01, p<0.001)  -0.00 (-0.01 to 0.00, p=0.570)
## 23                               -                               -
## 24   0.27 (-0.54 to 1.07, p=0.512)   0.17 (-0.81 to 1.15, p=0.732)
## 25    0.90 (0.10 to 1.69, p=0.028)   0.09 (-0.89 to 1.06, p=0.860)
## 26                               -                               -
## 27 -1.32 (-1.57 to -1.06, p<0.001)  -0.18 (-0.54 to 0.19, p=0.339)
## 28    0.90 (0.74 to 1.06, p<0.001)   0.12 (-0.17 to 0.40, p=0.425)
## 2                                -                               -
## 3  11.44 (11.37 to 11.51, p<0.001) 11.56 (11.28 to 11.83, p<0.001)
## 4     4.89 (4.83 to 4.95, p<0.001)    4.87 (4.62 to 5.12, p<0.001)
## 5  -4.11 (-4.30 to -3.92, p<0.001) -4.18 (-4.92 to -3.44, p<0.001)
## 43 -0.02 (-0.02 to -0.02, p<0.001)   0.02 (-0.00 to 0.04, p=0.113)
## 34    0.01 (0.00 to 0.01, p<0.001)    0.01 (0.00 to 0.02, p=0.019)
## 1     0.00 (0.00 to 0.00, p=0.035)  -0.00 (-0.00 to 0.00, p=0.579)
## 6  -0.02 (-0.02 to -0.02, p<0.001)  -0.01 (-0.03 to 0.00, p=0.133)
## 12 -0.01 (-0.01 to -0.01, p<0.001)  -0.00 (-0.01 to 0.01, p=0.673)
## 16  -0.57 (-2.61 to 1.47, p=0.585)  -2.46 (-5.34 to 0.43, p=0.095)
```

```r
# non-numeric argument to bianry operator:
# common_transportation, day_per_week_motor_vehicle, day_per_week_public_transit, day_per_week_walking, day_per_week_bike, children_household, education, household_income
```
