...
```
Interpretation:
Total: 1-unit change in WalkScore results in a .01 (-0.004-0.03) increase in BMI when GroceryScore is included.
ADE: 1-unit change in WalkScore results in a .009 (-0.01-0.00) decrease in BMI when GroceryScore is fixed.
ACME: 1-unit change in GroceryScore results in .02 (0.01-0.03) increase in BMI when WalkScore is fixed.
Prop. 1.72 (-3.71-7.85)
...
```
Interpretation:
Total: 1-unit change in WalkScore results in a .02 (0.006-0.04) increase in BMI when DiningandDrinkingScore is included.
ADE: 1-unit change in WalkScore results in a .02 (0.008-0.04) increase in BMI when DiningandDrinkingScore is fixed.
